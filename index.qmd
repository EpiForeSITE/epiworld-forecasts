...
if (spring_start >= 0) {
  t_params_used <- c(t_params_used, par_names[2])
  t_values_used <- c(t_values_used, init_lfmcmc_params[2])
}
if (summer_start >= 0) {
  t_params_used <- c(t_params_used, par_names[3])
  t_values_used <- c(t_values_used, init_lfmcmc_params[3])
}
if (fall_start >= 0) {
  t_params_used <- c(t_params_used, par_names[4])
  t_values_used <- c(t_values_used, init_lfmcmc_params[4])
}
if (winter_start >= 0) {
  t_params_used <- c(t_params_used, par_names[5])
