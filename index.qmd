...
observed_df <- data.frame(
  day = 1:90,
  counts = forecast_data$Daily.Cases,
  observed = TRUE
)
samp_median_df <- data.frame(
  day = 91:104,
  counts = forecast_sample_median,
  observed = FALSE
)

forecast_df <- rbind(observed_df, samp_median_df)
...
ggplot(forecast_df,
  aes(x = day, y = counts, color = observed)) +
  geom_line() +
